...
// Saida: nao tem
{
    ...
    avisoAssert(ml.log != NULL, "Cannot open memlog output");
    ...
    avisoAssert(retprint >= 0, "Nao foi possivel escrever registro");
    return result;
}
...
// Saida: resultado da obtencao do relogio
{
    ...
    avisoAssert(retclose == 0, "Nao foi possivel fechar o arquivo de registro");
